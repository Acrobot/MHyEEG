...
from models.model_singh import SinghFusionModel
from training_singh import Trainer
...
def main(args, n_workers):
    ...
    net = SinghFusionModel()
    print(net)
    
    wandb.init(project="SinghPaper")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_file_path', type=str, default='hci-tagging-database/torch_datasets/train_augmented_data.pt', help='Path to training .pt file')
    parser.add_argument('--test_file_path', type=str, default='hci-tagging-database/torch_datasets/test_data.pt', help='Path to test .pt file')
